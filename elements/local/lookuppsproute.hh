// -*- c-basic-offset: 4 -*-
#ifndef CLICK_LOOKUPPSPROUTE_HH
#define CLICK_LOOKUPPSPROUTE_HH
#include "psproutetable.hh"
CLICK_DECLS

#define IP_RT_CACHE2 1

class LookupPSPRoute : public PSPRouteTable { public:

    LookupPSPRoute();
    ~LookupPSPRoute();

    const char *class_name() const	{ return "LookupPSPRoute"; }
