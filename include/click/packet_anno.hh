...
// byte 48
#define QOS_ANNO_OFFSET		48
#define QOS_ANNO_SIZE		1
#define QOS_ANNO(p)			((p)->anno_u8(QOS_ANNO_OFFSET))
#define SET_QOS_ANNO(p, v) 	((p)->set_anno_u8(QOS_ANNO_OFFSET, (v)))

// bytes 49-52
#define LABEL_OUT_ANNO_OFFSET		49
#define LABEL_OUT_ANNO_SIZE			4
#define LABEL_OUT_ANNO(p)			((p)->anno_s32(LABEL_OUT_ANNO_OFFSET))
#define SET_LABEL_OUT_ANNO(p, v) 		((p)->set_anno_s32(LABEL_OUT_ANNO_OFFSET, (v)))